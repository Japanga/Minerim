...
{
	private static final ResourceLocation resourceLocation = new ResourceLocation("skyrim:GuiForge");
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
		...
		this.mc.renderEngine.func_110577_a(resourceLocation); //("/mods/skyrim/art/GuiForge.png");
