...
{
	private TileEntityGrindstone inventoryFurnace;

	public GuiGrindstone(InventoryPlayer inventoryPlayer, TileEntityGrindstone tileFurnace)
	{
		super(new ContainerGrindstone(inventoryPlayer, tileFurnace));
