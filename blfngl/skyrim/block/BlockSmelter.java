...
public class BlockSmelter extends BlockContainer
{
	...
	{
		return Skyrim.smelterIdle.blockID;
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
	{
		...
		{
			TileEntitySmelter tileFurnace = (TileEntitySmelter) world.getBlockTileEntity(x, y, z);
			player.openGui(Skyrim.instance, 0, world, x, y, z);
			return true;
		}
	}
