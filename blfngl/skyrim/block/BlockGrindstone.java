...
public class BlockGrindstone extends BlockContainer
{
	...
	public BlockGrindstone(int par1, boolean par2)
	{
	...
	{
		return Skyrim.grindstoneIdle.blockID;
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
	{
		...
		{
			TileEntityGrindstone tileFurnace = (TileEntityGrindstone) world.getBlockTileEntity(x, y, z);
			player.openGui(Skyrim.instance, 2, world, x, y, z);
			return true;
		}
	}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
	{
		...
		{
			TileEntityGrindstone tileentityfurnace = (TileEntityGrindstone)par1World.getBlockTileEntity(par2, par3, par4);
