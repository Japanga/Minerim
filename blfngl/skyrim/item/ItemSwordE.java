...
public class ItemSwordE extends Item
{
	public int damage;
	...
	public ItemSwordE(int var1, int var2, int var3, Item var4)
	{
		super(var1);
		this.setMaxDamage(-1);
		damage = var2;
	...
	public void onUpdate(ItemStack par1ItemStack, World var2, Entity par3Entity, int par4, boolean par5) 
	{
		...
		if(player.getHeldItem( )== par1ItemStack)
		{
			...
			if(speed == -5){player.addPotionEffect(new PotionEffect(Potion.digSlowdown.id, 20, 4));}
		}
	}
