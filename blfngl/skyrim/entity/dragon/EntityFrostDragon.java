...
public class EntityFrostDragon extends EntityDragon
{
	public EntityFrostDragon(World par1World)
	{
		super(par1World);
		texture = "/blfngl/skyrim/textures/FrostDragon.png";
	}
	...
	{
		par1EntityPlayer.addPotionEffect(new PotionEffect(Potion.moveSlowdown.getId(), 20 * 15, 3));
	}
}