...
public class TileEntityGrindstone extends TileEntity implements IInventory
{
	...
	private boolean canDoubleSmelt()
	{
		...
		{
			ItemStack itemstack = RecipesGrindstone.smelting().getDoubleSmeltingResult(this.inventory[0], this.inventory[1]);

			if (itemstack == null) return false;
			if (this.inventory[0].stackSize < RecipesGrindstone.smelting().getSlot1ReduceAmount(this.inventory[0]).stackSize) return false;
			if (this.inventory[1].stackSize < RecipesGrindstone.smelting().getSlot2ReduceAmount(this.inventory[1]).stackSize) return false;
	...
	public void smeltDoubleItem()
	{
		if (this.canDoubleSmelt())
		{
			...
			this.inventory[0].stackSize -= RecipesGrindstone.smelting().getSlot1ReduceAmount(this.inventory[0]).stackSize;
			this.inventory[1].stackSize -= RecipesGrindstone.smelting().getSlot2ReduceAmount(this.inventory[1]).stackSize;
